...
function componentWithDashboard(Component: FC) {
  return () => <PaperWithAlertContainer render={(showAlert) => <Component />} />
}
    ...
    <Router>
      <Switch>
        ...
        <PrivateRoute
          path="/products/:id"
          exact
          component={componentWithDashboard(EditProductForm)}
        />
        <PrivateRoute path="/products" exact component={componentWithDashboard(ProductList)} />
        <PrivateRoute
          path="/customers/:id"
          exact
          component={componentWithDashboard(EditCustomerForm)}
        />
