...
export const EditCustomerForm = () => (
  <EditItemForm
    redirectAfterSubmit="/customers"
    notFoundMessage={(id: number) => `Customer with id ${id} was not found!`}
    submitEditProps={{ mapper: (data) => data, apiPrefix: '/customers' }}
...
export const NewCustomerForm = (props: NewCustomerFormProps) => (
  <NewItemForm
    submitNewProps={{
      mapper: (data) => data,
      apiPrefix: '/customers',
