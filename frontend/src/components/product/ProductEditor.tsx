    ...
    return (
        <Grid container className={classes.container}>
            <Grid item xs={12} md={6}>
                <FormInput name="name" control={control} label="Product name" type="text"
                           errors={errors}
            ...
            <Grid item xs={12} md={2}>
                <FormInput name="available" control={control} label="In stock"
            ...
            <Grid item xs={12} md={4}>
                <ComboBoxInput options={categories ? categories : []}
...
export function EditProductForm() {
    ...
    return (
        <EditItemForm renderInputs={ProductInputs}
                      submitEditProps={
                          {
                              mapper: productDataMapping,
                              apiPrefix: '/products'
