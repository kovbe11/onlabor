...
fun findProductOrThrow(id: Int, repository: ProductRepository): Product {
    return repository.findById(id).orElseThrow {
        ResponseStatusException(HttpStatus.NOT_FOUND, "Product with id $id was not found!")
    }
}
...
fun findCustomerOrThrow(id: Int, repository: CustomerRepository): Customer {
    return repository.findById(id).orElseThrow {
        ResponseStatusException(HttpStatus.NOT_FOUND, "Customer with the id $id was not found!")
    }
}